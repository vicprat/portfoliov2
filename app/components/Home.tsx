                        ...
                        <div className="px-6 mx-auto max-w-7xl lg:px-8">
                            <div className="max-w-2xl mx-auto ">
                                ...
                                <div className="flex items-center justify-center mt-4 gap-x-6">
                                    <Link href="/proyectos">
                                        <motion.button
                                            className="rounded-md dark:bg-indigo-600 bg-teal-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm dark:hover:bg-indigo-500 hover:bg-teal-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                ...
                <ScrollReveal>
                    <div className="px-6 mx-auto max-w-7xl lg:px-8">
                        <div className="max-w-2xl mx-auto lg:text-center">
                            <h2 className="text-base font-semibold leading-7 text-indigo-600">Despliega más rapido</h2>
